...
const featuresList = [
  ...
  },
  {
    ...
    description:
      "You will find this landing, FAQ, terms, privacy, sign up, and sign in pages.",
  },
  {
    title: "Different sections",
    description:
      "The starter includes different feature sections, a pricing table, testimonial, CTA, and full forms.",
  },
];
    ...
    <section className="overflow-hidden">
      <div className="px-8 pt-32 mx-auto md:px-12 lg:px-24 max-w-7xl relative">
        <div className="max-w-2xl text-center mx-auto lg:text-balance mb-10">
          ...
          <h2 className="text-xl/snug leading-tight tracking-tight sm:text-2xl/snug md:text-3xl/snug capitalize lg:text-4xl/snug mt-4 font-medium text-base-900">
        ...
        <div className="lg:gap-x-8 lg:grid-cols-3 max-w-4xl mt-8 mx-auto sm:gap-x-6 sm:gap-y-12 sm:grid sm:grid-cols-2 sm:space-y-0 space-y-6 text-center text-sm items-start">
          {featuresList.map(({ title, description }) => (
            <div key={title} className="text-base-500 lg:text-balance">
              <strong className="text-base-700">{title}</strong> ━ {description}
            </div>
          ))}
        </div>
        <div className="relative w-full mx-auto max-w-7xl items-center py-12 pb-12">
          <div className="p-10 bg-accent-50 rounded-2xl">
            <OptimizedImage
              src="/dashboard.png"
              alt="#_"
              width={1200}
