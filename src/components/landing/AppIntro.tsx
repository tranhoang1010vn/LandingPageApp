        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="lg:pl-12">
            ...
            <p className="text-lg leading-relaxed mt-6 text-base-500 font-medium">
              Introducing our specialized mobile application designed for efficiency and seamless data management. 
              The Quawaco app version 1.8 brings powerful features directly to your fingertips, 
              allowing you to stay connected and productive even on the go.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/tutorials" className="text-primary inline-flex items-center gap-3">
            ...
            <div className="mt-12 grid grid-cols-2 gap-6 border-t border-base-200 pt-8">
              ...
              <div>
                ...
                <p className="text-sm text-base-500 font-medium">Phiên bản mới nhất</p>
              </div>
            </div>
          </div>
